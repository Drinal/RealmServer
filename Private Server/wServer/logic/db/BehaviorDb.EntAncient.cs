        ...
        static _ EntAncient = Behav()
            ...
            .Init(0x0924, Behaves("Actual Greater Nature Sprite",
                    ...
                    loot: new LootBehavior(
                        ...
                        Tuple.Create(100, new LootDef(0, 3, 0, 8,
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Quiver of Thunder")), //5% de chance de loot QoT
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Amulet of Resurrection")), //5% de chance de loot Ammy

                            Tuple.Create(0.10, (ILoot)new ItemLoot("Tincture of Dexterity")),
                            Tuple.Create(0.10, (ILoot)new ItemLoot("Tincture of Life")),
                            Tuple.Create(0.10, (ILoot)new ItemLoot("Green Drake Egg")),
